# Datasheet — DIESEL — DIESEL_FREEZE_395_PengKS
...
- **PCA / dimensionality:** effective rank 1.92; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.475, KS 0.152 (p 0.0373), Wasserstein 5.12
