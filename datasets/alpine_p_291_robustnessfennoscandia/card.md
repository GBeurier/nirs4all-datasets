# Datasheet — ALPINE — ALPINE_P_291_RobustnessFennoscandia
...
- **Description:** ALPINE dataset (regression). Auto-generated descriptor (verify before publication).
...
- **PCA / dimensionality:** effective rank 1.92; 4 PC(s) → 95% variance, 7 → 99%.
- **Train↔test target shift:** std. mean diff -0.0791, KS 0.184 (p 0.0126), Wasserstein 0.0149
