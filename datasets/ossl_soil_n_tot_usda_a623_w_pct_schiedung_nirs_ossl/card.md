# Datasheet — OSSL — soil_n_tot_usda_a623_w_pct_schiedung_nirs_ossl
...
- **Instances:** 239 spectra × 1076 wavelengths, 1 source(s).
...
- **Targets:** n_tot_usda_a623_w_pct (regression)
