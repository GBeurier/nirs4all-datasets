# Datasheet — FUSARIUM — Score_grp70_30_scoreQ
...
- **Instances:** 816 spectra × 2177 wavelengths, 1 source(s).
...
- **Targets:** ﻿Score (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.91; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff -0.00533, KS 0.0332 (p 0.987), Wasserstein 0.0758
