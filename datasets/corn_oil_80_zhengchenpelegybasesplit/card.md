# Datasheet — CORN — Corn_Oil_80_ZhengChenPelegYbaseSplit
...
- **Domain / purpose:** corn
- **Description:** CORN dataset (regression). Sample: Corn kernel. Trait: Oil content. Split: Y sorted. Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 80 spectra × 700 wavelengths, 1 source(s).
...
- **Targets:** Oil content (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.02; 1 PC(s) → 95% variance, 1 → 99%.
- **Train↔test target shift:** std. mean diff -0.000524, KS 0.0312 (p 1), Wasserstein 0.0153

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Oil content
