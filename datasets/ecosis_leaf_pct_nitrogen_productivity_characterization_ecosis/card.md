# Datasheet — ECOSIS — leaf_pct_nitrogen_productivity_characterization_ecosis
...
- **Instances:** 782 spectra × 1131 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1.0, 1131.0] nm; signal type absorbance.
- **Targets:** pct_NITROGEN (regression)
