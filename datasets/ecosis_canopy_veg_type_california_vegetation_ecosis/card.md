# Datasheet — ECOSIS — canopy_veg_type_california_vegetation_ecosis
...
- **Instances:** 503 spectra × 200 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [365.929993, 2496.23999] nm; signal type absorbance.
- **Targets:** veg_type (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.79; 2 PC(s) → 95% variance, 5 → 99%.
