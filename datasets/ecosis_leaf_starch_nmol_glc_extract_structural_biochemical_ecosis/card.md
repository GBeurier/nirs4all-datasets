# Datasheet — ECOSIS — leaf_starch_nmol_glc_extract_structural_biochemical_ecosis
...
- **Instances:** 155 spectra × 184 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [10202.0, 10391.0] cm-1; signal type unknown.
- **Targets:** starch_nmol_Glc_Extract (regression)
