# Datasheet — DIESEL — DIESEL_VISC_395_ZhengYbase
...
- **Targets:** VISC (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.97; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.00287, KS 0.00633 (p 1), Wasserstein 0.0117
