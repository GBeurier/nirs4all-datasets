# Datasheet — OSSL — soil_oc_usda_c729_w_pct_icraf_mirs_ossl
...
- **Instances:** 3700 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.1; 6 PC(s) → 95% variance, 13 → 99%.
