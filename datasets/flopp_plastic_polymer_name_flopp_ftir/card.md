# Datasheet — FLOPP — plastic_polymer_name_flopp_ftir
...
- **Instances:** 186 spectra × 1869 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 3.36; 9 PC(s) → 95% variance, 17 → 99%.
