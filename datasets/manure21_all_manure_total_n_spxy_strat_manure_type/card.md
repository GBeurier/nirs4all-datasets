# Datasheet — MANURE21 — All_manure_Total_N_SPXY_strat_Manure_type
...
- **Targets:** Total_N (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.18; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.101, KS 0.122 (p 0.0845), Wasserstein 0.849
