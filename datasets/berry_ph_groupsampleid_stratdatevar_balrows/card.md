# Datasheet — BERRY — ph_groupSampleID_stratDateVar_balRows
...
- **Description:** BERRY dataset (regression). Sample: Fresh leaf. Trait: Winegrape berry pH. Split: Stratified. Auto-generated descriptor (verify before publication).
- **Contributor:** GitHub

## Composition

- **Instances:** 1401 spectra × 2101 wavelengths, 1 source(s).
...
- **Targets:** ph (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.04; 1 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.122, KS 0.11 (p 0.000822), Wasserstein 0.0776

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Winegrape berry pH
...
- **Citation:** https://doi.org/10.1002/ppj2.70024
