# Datasheet — ECOSIS — leaf_ewt_dessain_reflectance_ecosis
...
- **Instances:** 200 spectra × 2001 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [400.0, 2400.0] nm; signal type absorbance.
- **Targets:** EWT (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.28; 3 PC(s) → 95% variance, 6 → 99%.
