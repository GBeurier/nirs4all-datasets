# Datasheet — EcoSIS Ground-leaf CABO spectra from herbarium project (reflectance)
...
- **Description:** EcoSIS Ground-leaf CABO spectra from herbarium project (reflectance). v2.0 standardized NIRS package: 1 spectral source(s), 31 declared target(s). Auto-generated from dataset_card.json (verify before publication).
- **Keywords:** nir, v2, ecosis
- **Contributor:** Ground-leaf CABO spectra from herbarium project
...
| GrowthForm | target | categorical | *Not specified.* | n=607, missing=0, classes=4, top broadleaf (×498) |
| SLA | target | numeric | *Not specified.* | n=607, missing=5, range 4.589–42.75, mean 15 ± 5.238 |
...
| EWT | target | numeric | *Not specified.* | n=607, missing=7, range 0.04878–0.2815, mean 0.1115 ± 0.03649 |
...
| ecosis_resource_id | metadata | categorical | *Not specified.* | n=607, missing=0, classes=1, top 5f2b17b3-aea2-4516-b98e-977029724557 (×607) |
...
| publication_doi | metadata | categorical | *Not specified.* | n=607, missing=0, classes=1, top 10.1101/2021.04.21.440856v5 \| 10.21232/DCpLBYke (×607) |
| citation | metadata | categorical | *Not specified.* | n=607, missing=0, classes=1, top Shan Kothari, Rosalie Beauchamp-Rioux, Etienne Laliberté and Jeannine Cavender-Bares. 2022. Ground-leaf CABO spectra from herbarium project. Data set. Available on-line [http://ecosis.org] from the Ecological Spectral Information System (EcoSIS). 10.21232/DCpLBYke (×607) |
...
| notes | metadata | categorical | *Not specified.* | n=607, missing=0, classes=1, top EcoSIS package ground-leaf-cabo-spectra-from-herbarium-project, no interpolation applied by project. (×607) |
...
- *Not specified.* — kind `url`, access `open`, license *Not specified.*: `https://data.ecosis.org/dataset/ground-leaf-cabo-spectra-from-herbarium-project`
...
- Reflectance spectroscopy allows rapid, accurate, and non-destructive estimates of functional traits from pressed leaves — [10.1101/2021.04.21.440856v5](https://doi.org/10.1101/2021.04.21.440856v5)
- Ground-leaf CABO spectra from herbarium project — [10.21232/DCpLBYke](https://doi.org/10.21232/DCpLBYke)
...
- **Content hash:** `33bf781fd3f3a669e0ac3f8d5cab7f2f78b13e0f338b53593d68e183598745d5`
- **Processing hash:** `acf6469820efbcc8009ef42963ec73ea1a45215aa67c792a3790c647d44a0383` | **metadata hash:** `3d9364b223a6ef6b7f86c1c2596edac21485ae5113ec93c7a0bce2aa6e8d9e56`
