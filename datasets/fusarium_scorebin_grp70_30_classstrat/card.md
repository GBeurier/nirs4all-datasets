# Datasheet — FUSARIUM — ScoreBin_grp70_30_classStrat
...
- **Targets:** ﻿ScoreBin (binary_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.91; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.00173, max class-proportion Δ 0.00173
