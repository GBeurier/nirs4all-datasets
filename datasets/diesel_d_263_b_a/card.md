# Datasheet — DIESEL — DIESEL_d_263_b-a
...
- **Instances:** 243 spectra × 401 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.22; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.224, KS 0.112 (p 0.386), Wasserstein 0.00246
