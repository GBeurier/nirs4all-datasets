# Datasheet — ECOSIS — leaf_lma_fresh_to_ecosis
...
- **Instances:** 265 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.85; 3 PC(s) → 95% variance, 5 → 99%.
