# Datasheet — DarkResp — Ca_GTtestSite
...
- **PCA / dimensionality:** effective rank 1.76; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.289, KS 0.257 (p 3.59e-07), Wasserstein 0.12
