# Datasheet — CORN — Corn_Starch_80_WangStyle_mp6spec
...
- **Targets:** starch (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.02; 1 PC(s) → 95% variance, 1 → 99%.
- **Train↔test target shift:** std. mean diff 0.551, KS 0.333 (p 0.0629), Wasserstein 0.435
