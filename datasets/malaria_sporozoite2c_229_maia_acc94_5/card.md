# Datasheet — MALARIA — Sporozoite2C_229_Maia_Acc94.5
...
- **Targets:** sporozoite2c (binary_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.17; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.229, max class-proportion Δ 0.258
