# Datasheet — MILK — Milk_Protein_1224_KS
...
- **Domain / purpose:** milk
- **Description:** MILK dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** Zenodo
...
- **Targets:** Prot (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.01; 1 PC(s) → 95% variance, 1 → 99%.
- **Train↔test target shift:** std. mean diff 0.0845, KS 0.0977 (p 0.0135), Wasserstein 0.0464
