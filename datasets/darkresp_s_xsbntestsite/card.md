# Datasheet — DarkResp — S_XSBNtestSite
...
- **Instances:** 525 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** S (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.84; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.778, KS 0.42 (p 1.61e-19), Wasserstein 0.0361
