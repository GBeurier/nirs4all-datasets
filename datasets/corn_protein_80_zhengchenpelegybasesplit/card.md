# Datasheet — CORN — Corn_Protein_80_ZhengChenPelegYbaseSplit
...
- **Targets:** protein (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.02; 1 PC(s) → 95% variance, 1 → 99%.
- **Train↔test target shift:** std. mean diff 0.0111, KS 0.0312 (p 1), Wasserstein 0.0388
