# Datasheet — FUSARIUM — Qamb_grp70_30
...
- **Targets:** ﻿Qamb (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.95; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff 0.0356, KS 0.0526 (p 0.81), Wasserstein 34
