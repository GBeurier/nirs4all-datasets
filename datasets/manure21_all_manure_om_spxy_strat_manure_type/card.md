# Datasheet — MANURE21 — All_manure_OM_SPXY_strat_Manure_type
...
- **Targets:** OM (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.16; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.237, KS 0.133 (p 0.0477), Wasserstein 28.1
