# Datasheet — MALARIA — Oocist2C_333_Maia_Acc87.6
...
- **Targets:** oocist2c (binary_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.26; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.0281, max class-proportion Δ 0.033
