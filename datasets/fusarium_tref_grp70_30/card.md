# Datasheet — FUSARIUM — Tref_grp70_30
...
- **Targets:** ﻿Tref (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.89; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff 0.004, KS 0.0388 (p 0.975), Wasserstein 0.128
