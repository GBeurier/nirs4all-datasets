# Datasheet — DIESEL — DIESEL_f_251_b-a
...
- **Instances:** 231 spectra × 401 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.25; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.196, KS 0.0731 (p 0.884), Wasserstein 0.799
