# Datasheet — BERRY — brix_groupSampleID_stratDateVar_balRows
...
- **Instances:** 2133 spectra × 2101 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.08; 1 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.0349, KS 0.0704 (p 0.0177), Wasserstein 0.566

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Winegrape berry tartaric acid content
