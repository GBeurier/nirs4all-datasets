# Datasheet — ALPINE — ALPINE_C_424_KS
...
- **PCA / dimensionality:** effective rank 2.04; 4 PC(s) → 95% variance, 8 → 99%.
- **Train↔test target shift:** std. mean diff 0.0372, KS 0.126 (p 0.327), Wasserstein 0.554
