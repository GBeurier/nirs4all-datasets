# Datasheet — FUSARIUM — gsw_grp70_30
...
- **Targets:** ﻿gsw (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.85; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff 0.0569, KS 0.0537 (p 0.793), Wasserstein 0.0103
