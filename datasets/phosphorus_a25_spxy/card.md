...
- **Description:** PHOSPHORUS dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** figshare

## Composition

- **Instances:** 245 spectra × 2101 wavelengths, 1 source(s).
...
- **Targets:** A25 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.79; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.00862, KS 0.0726 (p 0.924), Wasserstein 0.00848
