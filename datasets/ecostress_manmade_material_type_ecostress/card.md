# Datasheet — ECOSTRESS — manmade_material_type_ecostress
...
- **Instances:** 72 spectra × 2868 wavelengths, 1 source(s).
...
- **Targets:** material_type (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.24; 2 PC(s) → 95% variance, 6 → 99%.
