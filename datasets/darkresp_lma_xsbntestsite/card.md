# Datasheet — DarkResp — LMA_XSBNtestSite
...
- **Description:** DarkResp dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** tabpfn NIRS benchmark collection

## Composition

- **Instances:** 534 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.84; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.874, KS 0.363 (p 7.08e-15), Wasserstein 26.9
