# Datasheet — MILK — Milk_Fat_1224_KS
...
- **Instances:** 402 spectra × 255 wavelengths, 1 source(s).
...
- **Targets:** Fat (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.01; 1 PC(s) → 95% variance, 1 → 99%.
- **Train↔test target shift:** std. mean diff 0.323, KS 0.236 (p 2.36e-05), Wasserstein 0.397

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Fat content
