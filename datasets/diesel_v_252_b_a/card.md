# Datasheet — DIESEL — DIESEL_v_252_b-a
...
- **Instances:** 232 spectra × 401 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.2; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.00643, KS 0.0862 (p 0.784), Wasserstein 0.0396
