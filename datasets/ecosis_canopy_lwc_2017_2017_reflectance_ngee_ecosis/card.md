# Datasheet — ECOSIS — canopy_lwc_2017_2017_reflectance_ngee_ecosis
...
- **Instances:** 43 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 5.16; 8 PC(s) → 95% variance, 12 → 99%.
