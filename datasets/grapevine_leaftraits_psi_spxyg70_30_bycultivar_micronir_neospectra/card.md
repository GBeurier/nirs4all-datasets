# Datasheet — GRAPEVINE_LeafTraits — PSI_spxyG70_30_byCultivar_MicroNIR_NeoSpectra
...
- **Instances:** 113 spectra × 276 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.39; 2 PC(s) → 95% variance, 3 → 99%.
