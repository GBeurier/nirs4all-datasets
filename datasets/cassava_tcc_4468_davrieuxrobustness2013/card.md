# Datasheet — CASSAVA — Cassava_TCC_4468_DavrieuxRobustness2013
...
- **Instances:** 4468 spectra × 1050 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.61; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.688, KS 0.341 (p 5.8e-86), Wasserstein 3.16
