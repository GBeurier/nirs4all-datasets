# Datasheet — DIESEL — DIESEL_f_251_hlb-a
...
- **PCA / dimensionality:** effective rank 1.28; 3 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.231, KS 0.11 (p 0.399), Wasserstein 0.99
