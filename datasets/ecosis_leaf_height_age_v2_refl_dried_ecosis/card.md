# Datasheet — ECOSIS — leaf_height_age_v2_refl_dried_ecosis
...
- **Instances:** 1226 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Height_Age (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.89; 4 PC(s) → 95% variance, 8 → 99%.
