# Datasheet — TIMESERIES — puree_fraise_authenticite_ts
...
- **Instances:** 983 spectra × 235 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [400.0, 4000.0] cm-1; signal type preprocessed.
- **Targets:** authenticite (binary_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.95; 5 PC(s) → 95% variance, 11 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.000445, max class-proportion Δ 0.000503
