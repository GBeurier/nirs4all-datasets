# Datasheet — PHOSPHORUS — PPUE_spxy
...
- **PCA / dimensionality:** effective rank 1.77; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.296, KS 0.184 (p 0.0519), Wasserstein 19.2
