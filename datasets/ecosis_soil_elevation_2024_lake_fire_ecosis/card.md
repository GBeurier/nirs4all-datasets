# Datasheet — ECOSIS — soil_elevation_2024_lake_fire_ecosis
...
- **Instances:** 106 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** elevation (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.24; 2 PC(s) → 95% variance, 3 → 99%.
