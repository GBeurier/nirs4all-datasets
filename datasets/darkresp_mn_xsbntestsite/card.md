# Datasheet — DarkResp — Mn_XSBNtestSite
...
- **Instances:** 521 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Mn (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.83; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.42, KS 0.201 (p 0.000113), Wasserstein 0.0236
