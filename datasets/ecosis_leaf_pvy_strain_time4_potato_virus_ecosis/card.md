# Datasheet — ECOSIS — leaf_pvy_strain_time4_potato_virus_ecosis
...
- **Instances:** 80 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** PVY_Strain (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.54; 3 PC(s) → 95% variance, 6 → 99%.
