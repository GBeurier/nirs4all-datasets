# Datasheet — GRAPEVINE_LeafTraits — An_spxyG70_30_byCultivar_NeoSpectra
...
- **Instances:** 119 spectra × 257 wavelengths, 1 source(s).
...
- **Train↔test target shift:** std. mean diff 0.287, KS 0.149 (p 0.563), Wasserstein 1.16
