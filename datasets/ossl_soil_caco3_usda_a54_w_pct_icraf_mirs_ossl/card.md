# Datasheet — OSSL — soil_caco3_usda_a54_w_pct_icraf_mirs_ossl
...
- **Instances:** 1117 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.05; 6 PC(s) → 95% variance, 13 → 99%.
