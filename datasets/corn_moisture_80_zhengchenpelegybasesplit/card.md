# Datasheet — CORN — Corn_Moisture_80_ZhengChenPelegYbaseSplit
...
- **Domain / purpose:** corn
- **Description:** CORN dataset (regression). Auto-generated descriptor (verify before publication).
...
- **Targets:** moisture (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.02; 1 PC(s) → 95% variance, 1 → 99%.
- **Train↔test target shift:** std. mean diff -0.00978, KS 0.0312 (p 1), Wasserstein 0.0319
