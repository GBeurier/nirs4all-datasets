# Datasheet — MALARIA — Malaria_Oocist_333_Maia
...
- **Instances:** 333 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** oocyst content (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.27; 3 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.0729, KS 0.089 (p 0.577), Wasserstein 631

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** oocyst content
