# Datasheet — ALPINE — ALPINE_N_552_KS
...
- **Description:** ALPINE dataset (regression). Sample: Ground dried leaves. Trait: N. Split: KS. Auto-generated descriptor (verify before publication).
- **Contributor:** DataverseNO

## Composition

- **Instances:** 552 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** N (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 2.05; 4 PC(s) → 95% variance, 8 → 99%.
- **Train↔test target shift:** std. mean diff 0.0803, KS 0.0904 (p 0.576), Wasserstein 0.139
