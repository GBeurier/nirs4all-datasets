# Datasheet — ECOSIS — canopy_species_california_vegetation_ecosis
...
- **Instances:** 448 spectra × 200 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [365.929993, 2496.23999] nm; signal type unknown.
- **Targets:** species (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.73; 2 PC(s) → 95% variance, 5 → 99%.
