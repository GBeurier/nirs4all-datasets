# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_lucas_woodwell_nirs_ossl
...
- **Instances:** 589 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.19; 2 PC(s) → 95% variance, 4 → 99%.
