# Datasheet — OSSL — soil_caco3_usda_a54_w_pct_jovic_mirs_ossl
...
- **Instances:** 45 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.33; 2 PC(s) → 95% variance, 6 → 99%.
