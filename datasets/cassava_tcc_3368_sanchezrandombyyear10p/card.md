# Datasheet — CASSAVA — Cassava_TCC_3368_SanchezRandomByYear10p
...
- **Instances:** 3368 spectra × 1050 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.6; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.0166, KS 0.0414 (p 0.661), Wasserstein 0.167
