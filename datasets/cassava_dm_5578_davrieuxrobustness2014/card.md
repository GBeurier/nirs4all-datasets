# Datasheet — CASSAVA — Cassava_DM_5578_DavrieuxRobustness2014
...
- **Instances:** 5578 spectra × 1050 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.66; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.676, KS 0.316 (p 4.63e-38), Wasserstein 3.45
