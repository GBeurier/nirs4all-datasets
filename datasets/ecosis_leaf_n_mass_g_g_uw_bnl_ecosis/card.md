# Datasheet — ECOSIS — leaf_n_mass_g_g_uw_bnl_ecosis
...
- **Instances:** 358 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** N_mass_g_g (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.3; 4 PC(s) → 95% variance, 7 → 99%.
