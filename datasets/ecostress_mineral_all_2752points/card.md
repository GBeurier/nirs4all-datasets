...
- **Alignment:** observation level; 16 sample(s), 17 observation(s) total; sample_id available: True.
- **Repetitions per sample:** 1–2 (mean 1.062).
...
| --- | --- | --- | --- | --- |
| material_name | target | categorical | *Not specified.* | n=16, missing=0, classes=16, top Gaylussite Na2Ca(CO3)2 * 5H2O (×1) |
| class_label | target | categorical | *Not specified.* | n=16, missing=0, classes=4, top Borate (×8) |
| owner | target | categorical | *Not specified.* | n=16, missing=0, classes=2, top Smithsonian Institute, National Museum of Nat. History (×10) |
| ecostress_resource_id | metadata | categorical | *Not specified.* | n=16, missing=0, classes=16, top mineral.borate.none.coarse.all.nmnh102876-2.usgs.perknic.spectrum (×1) |
| category | metadata | categorical | *Not specified.* | n=16, missing=0, classes=1, top mineral (×16) |
| material_type | metadata | categorical | *Not specified.* | n=16, missing=0, classes=1, top Mineral (×16) |
| site | metadata | categorical | *Not specified.* | n=16, missing=16, classes=0, — |
| location | metadata | categorical | *Not specified.* | n=16, missing=0, classes=15, top Boron, California (×2) |
...
| sample_description | metadata | categorical | *Not specified.* | n=16, missing=0, classes=16, top Gaylussite powder from Searles Lake, CASample was Unsieved coarse powder. Original ASTER Spectral Library name was usgs.perknic.mineral.borate.none.coarse.gaylusc.spectrum.txt (×1) |
| instrument | metadata | categorical | *Not specified.* | n=16, missing=0, classes=1, top usgs.perknic (×16) |
| acquisition_mode | metadata | categorical | *Not specified.* | n=16, missing=0, classes=1, top Directional Hemispherical Reflectance (×16) |
| signal_type | metadata | categorical | *Not specified.* | n=16, missing=0, classes=1, top Reflectance (percent) (×16) |
| axis_unit | metadata | categorical | *Not specified.* | n=16, missing=0, classes=1, top Wavelength (micrometers) (×16) |
| axis_min | metadata | numeric | *Not specified.* | n=16, missing=0, range 0.4–0.4, mean 0.4 ± 0 |
| axis_max | metadata | numeric | *Not specified.* | n=16, missing=0, range 13.9–13.9, mean 13.9 ± 0 |
| n_points_original | metadata | numeric | *Not specified.* | n=16, missing=0, range 2752–2752, mean 2752 ± 0 |
...
- **Content hash:** `0ee3ea92dd2ecf10ea45265ebb54781fd3a8180c2d84ad68173f4dc665797557`
