# Datasheet — DIESEL — DIESEL_d_263_hlb-a
...
- **Instances:** 263 spectra × 401 wavelengths, 1 source(s).
...
- **Targets:** d (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.26; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.123, KS 0.102 (p 0.467), Wasserstein 0.00156
