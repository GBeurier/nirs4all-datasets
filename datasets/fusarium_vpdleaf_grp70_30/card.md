# Datasheet — FUSARIUM — VPDleaf_grp70_30
...
- **Targets:** ﻿VPDleaf (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.97; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff -0.041, KS 0.0469 (p 0.901), Wasserstein 0.0957
