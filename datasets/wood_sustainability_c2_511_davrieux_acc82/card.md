# Datasheet — Wood_Sustainability — C2_511_Davrieux_Acc82
...
- **Targets:** c2 (binary_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.18; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.0839, max class-proportion Δ 0.0985
