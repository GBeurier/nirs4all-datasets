# Datasheet — ECOSIS — leaf_sla_cm2_gdw_v4_tran_nasa_ecosis
...
- **Instances:** 714 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.1; 1 PC(s) → 95% variance, 4 → 99%.
