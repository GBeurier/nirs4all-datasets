...
- **Description:** COLZA dataset (regression). Auto-generated descriptor (verify before publication).
...
- **PCA / dimensionality:** effective rank 1.49; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.0726, KS 0.019 (p 0.976), Wasserstein 0.259
