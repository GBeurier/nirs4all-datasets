# Datasheet — DIESEL — DIESEL_BP50_395_ZhengYbase
...
- **Targets:** BP50 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.73; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.00428, KS 0.00633 (p 1), Wasserstein 0.475
