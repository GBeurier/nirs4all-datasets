# Datasheet — DIESEL — DIESEL_t_256_b-a
...
- **Instances:** 236 spectra × 401 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.24; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.0474, KS 0.0678 (p 0.951), Wasserstein 0.615
