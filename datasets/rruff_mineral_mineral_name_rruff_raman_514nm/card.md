# Datasheet — RRUFF — mineral_mineral_name_rruff_raman_514nm
...
- **Instances:** 387 spectra × 759 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [235.479, 1204.582] nm; signal type unknown.
- **Targets:** mineral_name (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 22.4; 56 PC(s) → 95% variance, >60 → 99%.
