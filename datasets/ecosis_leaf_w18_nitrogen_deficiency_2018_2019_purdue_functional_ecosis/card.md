# Datasheet — ECOSIS — leaf_w18_nitrogen_deficiency_2018_2019_purdue_functional_ecosis
...
- **Description:** ECOSIS dataset (classification). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 987 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** W18_Nitrogen_Deficiency (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.15; 4 PC(s) → 95% variance, 8 → 99%.
