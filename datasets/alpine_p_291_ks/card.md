# Datasheet — ALPINE — ALPINE_P_291_KS
...
- **Description:** ALPINE dataset (regression). Sample: Ground dried leaves. Trait: P. Split: KS. Auto-generated descriptor (verify before publication).
- **Contributor:** DataverseNO

## Composition

- **Instances:** 291 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** P (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.18; 4 PC(s) → 95% variance, 8 → 99%.
- **Train↔test target shift:** std. mean diff -0.262, KS 0.186 (p 0.13), Wasserstein 0.0382
