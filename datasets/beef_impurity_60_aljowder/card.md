# Datasheet — BEEF_Impurity — Beef_Impurity_60_AlJowder

_Generated from the dataset descriptor and identity card (Datasheets for Datasets, Gebru et al. 2021)._

## Motivation

- **Domain / purpose:** beef_impurity
- **Description:** BEEF_Impurity dataset (classification). Auto-generated descriptor (verify before publication).
- **Contributor:** tabpfn NIRS benchmark collection

## Composition

- **Instances:** 60 spectra × 470 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [990.0, 1894.232] nm; signal type preprocessed.
- **Targets:** 60 (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.61; 3 PC(s) → 95% variance, 4 → 99%.
