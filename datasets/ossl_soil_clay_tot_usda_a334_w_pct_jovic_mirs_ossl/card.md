# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_jovic_mirs_ossl
...
- **Instances:** 135 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.46; 3 PC(s) → 95% variance, 7 → 99%.
