# Datasheet — ECOSIS — asphalt_material_urban_materials_ecosis
...
- **Instances:** 60 spectra × 256 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [0.45, 0.95] nm; signal type unknown.
- **Targets:** Material (binary_classification)
