# Datasheet — OSSL — soil_ph_h2o_usda_a268_index_kellogg_nirs_ossl
...
- **Instances:** 52867 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.04; 1 PC(s) → 95% variance, 2 → 99%.
