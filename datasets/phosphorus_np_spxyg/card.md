...
- **Description:** PHOSPHORUS dataset (regression). Sample: Fresh leaf. Trait: nucleic acid P content. Split: spxy by species. Auto-generated descriptor (verify before publication).
...
- **Targets:** NP (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.86; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.966, KS 0.521 (p 6.08e-15), Wasserstein 0.108

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** nucleic acid P content
