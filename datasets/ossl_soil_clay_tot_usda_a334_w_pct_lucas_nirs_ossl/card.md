# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_lucas_nirs_ossl
...
- **Instances:** 22650 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.15; 2 PC(s) → 95% variance, 4 → 99%.
