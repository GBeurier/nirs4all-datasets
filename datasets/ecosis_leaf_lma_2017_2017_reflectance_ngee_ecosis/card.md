# Datasheet — ECOSIS — leaf_lma_2017_2017_reflectance_ngee_ecosis
...
- **Instances:** 163 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.79; 3 PC(s) → 95% variance, 6 → 99%.
