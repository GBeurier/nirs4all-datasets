# Datasheet — DarkResp — Mg_CBtestSite
...
- **PCA / dimensionality:** effective rank 1.69; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.147, KS 0.102 (p 0.189), Wasserstein 0.0179
