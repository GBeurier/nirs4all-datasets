# Datasheet — LUCAS — LUCAS_SOC_Organic_1102_NocitaKS
...
- **Instances:** 1102 spectra × 4200 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.4; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.25, KS 0.192 (p 6.11e-08), Wasserstein 28.1
