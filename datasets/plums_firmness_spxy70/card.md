# Datasheet — PLUMS — Firmness_spxy70
...
- **Targets:** Firmness (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.11; 2 PC(s) → 95% variance, 2 → 99%.
- **Train↔test target shift:** std. mean diff 0.349, KS 0.333 (p 0.252), Wasserstein 0.28

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Firmness
