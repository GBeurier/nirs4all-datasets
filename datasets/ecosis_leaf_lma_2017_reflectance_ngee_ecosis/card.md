# Datasheet — ECOSIS — leaf_lma_2017_reflectance_ngee_ecosis
...
- **Instances:** 343 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.25; 4 PC(s) → 95% variance, 6 → 99%.
