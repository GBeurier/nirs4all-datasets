# Datasheet — OSSL — soil_oc_usda_c729_w_pct_kellogg_mirs_ossl
...
- **Instances:** 85669 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.82; 6 PC(s) → 95% variance, 12 → 99%.
