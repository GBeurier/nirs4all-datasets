# Datasheet — DIESEL — DIESEL_f_251_hla-b
...
- **Instances:** 251 spectra × 401 wavelengths, 1 source(s).
...
- **Targets:** f (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.3; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.115, KS 0.0742 (p 0.848), Wasserstein 0.605
