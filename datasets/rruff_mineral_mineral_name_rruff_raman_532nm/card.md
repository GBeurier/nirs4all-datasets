# Datasheet — RRUFF — mineral_mineral_name_rruff_raman_532nm
...
- **Description:** RRUFF dataset (classification). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 2899 spectra × 1992 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [239.9483, 1199.8094] nm; signal type unknown.
- **Targets:** mineral_name (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.92; 10 PC(s) → 95% variance, 32 → 99%.
