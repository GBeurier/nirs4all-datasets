# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_icraf_mirs_ossl
...
- **Instances:** 3740 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.11; 6 PC(s) → 95% variance, 13 → 99%.
