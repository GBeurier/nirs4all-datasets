# Datasheet — OSSL — soil_caco3_usda_a54_w_pct_neospectra_mirs_ossl
...
- **Instances:** 683 spectra × 1701 wavelengths, 1 source(s).
...
- **Targets:** caco3_usda_a54_w_pct (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.9; 6 PC(s) → 95% variance, 12 → 99%.
