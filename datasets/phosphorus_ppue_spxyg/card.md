# Datasheet — PHOSPHORUS — PPUE_spxyG
...
- **Targets:** PPUE (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.85; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -1.14, KS 0.504 (p 3.88e-13), Wasserstein 65.2
