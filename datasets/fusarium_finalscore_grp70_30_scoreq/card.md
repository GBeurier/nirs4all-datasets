# Datasheet — FUSARIUM — FinalScore_grp70_30_scoreQ
...
- **Description:** FUSARIUM dataset (regression). Sample: Fresh leaf. Trait: Fusarium score. Split: Group stratified. Auto-generated descriptor (verify before publication).
- **Contributor:** https://doi.org/10.5281/zenodo.16217833

## Composition

- **Instances:** 935 spectra × 2177 wavelengths, 1 source(s).
...
- **Targets:** ﻿FinalScore (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.92; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff 0.0104, KS 0.115 (p 0.00962), Wasserstein 0.0796

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Fusarium score
