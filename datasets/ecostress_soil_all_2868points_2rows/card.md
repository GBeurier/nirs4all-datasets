# Datasheet — ECOSTRESS soil all axis e7e7baa6
...
- **Description:** ECOSTRESS soil all axis e7e7baa6. v2.0 standardized NIRS package: 1 spectral source(s), 2 declared target(s). Auto-generated from dataset_card.json (verify before publication).
...
| --- | --- | --- | --- | --- | --- | --- |
| X | soil all | source instruments vary by sample | other | 0.4–14.98 none | 2 | 2868 |

### Variables (Y / metadata)

| Name | Role | Type | Unit | Summary |
| --- | --- | --- | --- | --- |
| material_name | target | categorical | *Not specified.* | n=2, missing=0, classes=2, top Light yellowish brown loam (×1) |
| subclass | target | categorical | *Not specified.* | n=2, missing=0, classes=2, top Calciorthid (×1) |
| ecostress_resource_id | metadata | categorical | *Not specified.* | n=2, missing=0, classes=2, top soil.aridisol.calciorthid.none.all.84p3721.jhu.becknic.spectrum (×1) |
...
| location | metadata | categorical | *Not specified.* | n=2, missing=0, classes=2, top 1.5 km NE of Minkher Gharbi, Syria via USDA Soil Conservationservice. (×1) |
...
| sample_description | metadata | categorical | *Not specified.* | n=2, missing=0, classes=2, top The parent material is igneous-basaltic rock. Physiography: level to undulating upland plains. Light yellowish brown loam, (typic xerollic). Original ASTER Spectral Library name was jhu.becknic.soil.aridisol.calciorthid.coarse.84P3721.spectrum.txt (×1) |
...
| notes | metadata | categorical | *Not specified.* | n=2, missing=0, classes=2, top soil.aridisol.calciorthid.none.all.84p3721.jhu.becknic.ancillary.txt (×1) |
...
- **Content hash:** `ce606c2f34fd427a36365ccadfb1a3c75b23c1bd59a1b4c1366778cb105483d5`
- **Processing hash:** `6a39981b29f37b541a9bd00be91b4e0475eba749452912b54aa4172179d25f34` | **metadata hash:** `2746d840e021e024b8e0ae6ee167a3f3e021cd1fe30e0a0b538ef1a49af5fc3a`
