...
- **PCA / dimensionality:** effective rank 1.84; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.233, KS 0.213 (p 0.0117), Wasserstein 0.0461
