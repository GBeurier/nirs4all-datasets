# Datasheet — DarkResp — Ca_CBtestSite
...
- **Instances:** 505 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Ca (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.73; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.724, KS 0.436 (p 1.05e-18), Wasserstein 0.265
