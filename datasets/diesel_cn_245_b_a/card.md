# Datasheet — DIESEL — DIESEL_cn_245_b-a
...
- **Instances:** 225 spectra × 401 wavelengths, 1 source(s).
...
- **Train↔test target shift:** std. mean diff 0.0577, KS 0.078 (p 0.84), Wasserstein 0.359
