# Datasheet — DarkResp — Rd25_XSBNtestSite
...
- **Description:** DarkResp dataset (regression). Sample: Forest tree fresh leaf. Trait: Dark respiration. Split: Site. Auto-generated descriptor (verify before publication).
- **Contributor:** doi: 10.1111/nph.20267

## Composition

- **Instances:** 470 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Rd25 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.83; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.458, KS 0.251 (p 3.5e-06), Wasserstein 0.132

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Dark respiration
