# Datasheet — ECOSIS — canopy_heading_n_2007_paddy_rice_ecosis
...
- **Instances:** 60 spectra × 1451 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [350.0, 1800.0] nm; signal type unknown.
- **Targets:** Heading_N (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.54; 3 PC(s) → 95% variance, 5 → 99%.
