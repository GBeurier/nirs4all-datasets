# Datasheet — ARABIDOPSIS_CEFE — InOut_1264
...
- **Instances:** 1263 spectra × 2152 wavelengths, 1 source(s).
...
- **Targets:** InOut (binary_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.96; 4 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.3, max class-proportion Δ 0.349
