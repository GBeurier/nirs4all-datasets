...
- **PCA / dimensionality:** effective rank 1.8; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.0973, KS 0.121 (p 0.368), Wasserstein 0.00369
