# Datasheet — WOOD_density — WOOD_Density_402_Olale
...
- **Description:** WOOD_density dataset (regression). Sample: Ground dried wood auger cores. Trait: Wood density. Split: ks. Auto-generated descriptor (verify before publication).
- **Contributor:** Dataverse

## Composition

- **Instances:** 402 spectra × 1038 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [4003.687134, 8003.517151] cm-1; signal type absorbance.
- **Targets:** Wood density (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 3.57; 7 PC(s) → 95% variance, 13 → 99%.
- **Train↔test target shift:** std. mean diff -0.248, KS 0.139 (p 0.0371), Wasserstein 0.0408

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Wood density
