# Datasheet — DIESEL — DIESEL_FLASH_395_PengKS
...
- **Targets:** FLASH (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.83; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.0803, KS 0.107 (p 0.273), Wasserstein 1.74
