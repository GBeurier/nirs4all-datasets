# Datasheet — ECOSIS — leaf_equivalent_water_thickness_g_cm2_reflectance_refl_optical_ecosis
...
- **Description:** ECOSIS dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 330 spectra × 2101 wavelengths, 1 source(s).
...
- **Targets:** Equivalent_Water_Thickness_g_cm2 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.82; 3 PC(s) → 95% variance, 6 → 99%.
