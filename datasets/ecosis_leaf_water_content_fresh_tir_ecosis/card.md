# Datasheet — ECOSIS — leaf_water_content_fresh_tir_ecosis
...
- **Instances:** 284 spectra × 1738 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [2.50019, 15.3869] nm; signal type unknown.
- **Targets:** Water_Content (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.31; 2 PC(s) → 95% variance, 6 → 99%.
