# Datasheet — OSSL — soil_oc_usda_c729_w_pct_schiedung_mirs_ossl
...
- **Instances:** 259 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.81; 5 PC(s) → 95% variance, 8 → 99%.
