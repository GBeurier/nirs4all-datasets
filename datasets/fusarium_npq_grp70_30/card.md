# Datasheet — FUSARIUM — NPQ_grp70_30
...
- **Targets:** ﻿NPQ (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff -0.0191, KS 0.0693 (p 0.62), Wasserstein 0.0234
