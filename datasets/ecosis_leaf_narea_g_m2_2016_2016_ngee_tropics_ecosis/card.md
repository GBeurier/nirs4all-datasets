# Datasheet — ECOSIS — leaf_narea_g_m2_2016_2016_ngee_tropics_ecosis
...
- **Instances:** 187 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Narea_g_m2 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.29; 3 PC(s) → 95% variance, 6 → 99%.
