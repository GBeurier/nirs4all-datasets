# Datasheet — GRAPEVINE_LeafTraits — PSI_spxyG70_30_byCultivar_ASD
...
- **Instances:** 109 spectra × 2101 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.08; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff 0.154, KS 0.148 (p 0.617), Wasserstein 0.084
