# Datasheet — ECOSIS — leaf_sla_cm2_g_dw_uw_bnl_ecosis
...
- **Instances:** 97 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** SLA_cm2_g_DW (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.17; 4 PC(s) → 95% variance, 7 → 99%.
