# Datasheet — DIESEL — DIESEL_v_252_hlb-a
...
- **PCA / dimensionality:** effective rank 1.23; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.0216, KS 0.101 (p 0.502), Wasserstein 0.0498
