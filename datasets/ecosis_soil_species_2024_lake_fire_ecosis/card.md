# Datasheet — ECOSIS — soil_species_2024_lake_fire_ecosis
...
- **Instances:** 34 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.44; 2 PC(s) → 95% variance, 4 → 99%.
