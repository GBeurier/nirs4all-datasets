# Datasheet — ECOSIS — canopy_ewt_to_foliar_ecosis
...
- **Instances:** 650 spectra × 426 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [384.0, 2512.0] nm; signal type unknown.
- **Targets:** EWT (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 3.78; 15 PC(s) → 95% variance, 29 → 99%.
