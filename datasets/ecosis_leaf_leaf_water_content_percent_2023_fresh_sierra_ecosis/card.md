# Datasheet — ECOSIS — leaf_leaf_water_content_percent_2023_fresh_sierra_ecosis
...
- **Instances:** 363 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** leaf_water_content_percent (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.51; 3 PC(s) → 95% variance, 4 → 99%.
