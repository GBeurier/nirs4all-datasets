# Datasheet — ECOSIS — canopy_narea_2017_2017_reflectance_ngee_ecosis
...
- **Instances:** 41 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Narea (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 5.18; 8 PC(s) → 95% variance, 12 → 99%.
