# Datasheet — RRUFF — mineral_mineral_name_rruff_raman_785nm
...
- **Instances:** 682 spectra × 2019 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [227.465, 1200.3428] nm; signal type unknown.
- **Targets:** mineral_name (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.24; 20 PC(s) → 95% variance, 47 → 99%.
