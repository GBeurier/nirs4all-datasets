# Datasheet — GRAPEVINE_LeafTraits — WCf_spxyG70_30_byCultivar_ASD
...
- **Instances:** 1452 spectra × 2101 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.46; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.0807, KS 0.0687 (p 0.105), Wasserstein 0.00321
