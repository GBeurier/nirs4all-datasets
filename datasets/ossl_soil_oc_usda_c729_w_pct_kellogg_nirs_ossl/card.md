# Datasheet — OSSL — soil_oc_usda_c729_w_pct_kellogg_nirs_ossl
...
- **Instances:** 85669 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.23; 2 PC(s) → 95% variance, 4 → 99%.
