# Datasheet — ECOSIS — leaf_measurement_v2_fresh_to_ecosis
...
- **Instances:** 2379 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** measurement (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.7; 2 PC(s) → 95% variance, 4 → 99%.
