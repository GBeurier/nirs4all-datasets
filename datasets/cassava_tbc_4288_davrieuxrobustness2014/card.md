# Datasheet — CASSAVA — Cassava_TBC_4288_DavrieuxRobustness2014
...
- **Instances:** 4288 spectra × 1050 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.71; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 1.64, KS 0.635 (p 5.62e-160), Wasserstein 4.87
