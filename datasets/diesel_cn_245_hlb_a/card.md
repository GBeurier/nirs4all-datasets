# Datasheet — DIESEL — DIESEL_cn_245_hlb-a
...
- **Instances:** 245 spectra × 401 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [750.0, 1550.0] nm; signal type unknown.
- **Targets:** cn (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.41; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.0892, KS 0.0774 (p 0.822), Wasserstein 0.526
