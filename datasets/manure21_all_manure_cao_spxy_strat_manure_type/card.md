# Datasheet — MANURE21 — All_manure_CaO_SPXY_strat_Manure_type
...
- **Description:** MANURE21 dataset (regression). Sample: Cattle manure. Trait: CaO content. Split: strat spxy. Auto-generated descriptor (verify before publication).
...
- **Targets:** CaO (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.16; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.268, KS 0.116 (p 0.119), Wasserstein 4.97

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** CaO content
