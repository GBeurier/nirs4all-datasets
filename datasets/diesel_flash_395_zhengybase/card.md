# Datasheet — DIESEL — DIESEL_FLASH_395_ZhengYbase
...
- **PCA / dimensionality:** effective rank 1.8; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.083, KS 0.0253 (p 1), Wasserstein 0.699
