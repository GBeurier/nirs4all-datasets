# Datasheet — DIESEL — DIESEL_CN_381_ZhengYbase
...
- **Instances:** 381 spectra × 401 wavelengths, 1 source(s).
...
- **Targets:** CN (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.83; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.0103, KS 0.00984 (p 1), Wasserstein 0.102
