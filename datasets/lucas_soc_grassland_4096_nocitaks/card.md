# Datasheet — LUCAS — LUCAS_SOC_Grassland_4096_NocitaKS
...
- **Instances:** 4096 spectra × 4200 wavelengths, 1 source(s).
...
- **Targets:** soc (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.27; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.572, KS 0.233 (p 1.5e-41), Wasserstein 13.1
