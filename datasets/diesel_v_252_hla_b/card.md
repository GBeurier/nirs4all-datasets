# Datasheet — DIESEL — DIESEL_v_252_hla-b
...
- **Instances:** 252 spectra × 401 wavelengths, 1 source(s).
...
- **Targets:** v (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.22; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.0328, KS 0.0677 (p 0.911), Wasserstein 0.0518
