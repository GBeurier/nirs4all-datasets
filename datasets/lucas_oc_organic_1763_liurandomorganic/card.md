# Datasheet — LUCAS — LUCAS_OC_Organic_1763_LiuRandomOrganic
...
- **Description:** LUCAS dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 1763 spectra × 4200 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.48; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.00816, KS 0.0331 (p 0.765), Wasserstein 4.41
