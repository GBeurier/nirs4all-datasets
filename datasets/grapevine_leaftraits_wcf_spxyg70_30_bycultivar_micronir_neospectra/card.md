# Datasheet — GRAPEVINE_LeafTraits — WCf_spxyG70_30_byCultivar_MicroNIR_NeoSpectra
...
- **Instances:** 1437 spectra × 276 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.31; 3 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.0715, KS 0.0636 (p 0.164), Wasserstein 0.00296
