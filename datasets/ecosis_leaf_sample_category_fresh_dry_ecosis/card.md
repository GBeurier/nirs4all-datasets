# Datasheet — ECOSIS — leaf_sample_category_fresh_dry_ecosis
...
- **Instances:** 75 spectra × 826 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [0.4, 2.5] nm; signal type unknown.
- **Targets:** Sample_category (binary_classification)
