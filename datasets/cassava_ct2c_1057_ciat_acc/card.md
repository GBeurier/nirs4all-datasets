# Datasheet — Cassava — CT2C_1057_CIAT_Acc
...
- **Description:** Cassava dataset (classification). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 1056 spectra × 1050 wavelengths, 1 source(s).
...
- **Targets:** ct2c (binary_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.88; 3 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.164, max class-proportion Δ 0.184
