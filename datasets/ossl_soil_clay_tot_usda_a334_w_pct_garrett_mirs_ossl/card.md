# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_garrett_mirs_ossl
...
- **Instances:** 142 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.76; 5 PC(s) → 95% variance, 10 → 99%.
