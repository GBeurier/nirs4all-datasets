# Datasheet — TIMESERIES — spiritueux_whisky_bouteille_taux_ethanol_ts
...
- **Instances:** 1004 spectra × 1751 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [226.0, 1101.0] nm; signal type preprocessed.
- **Targets:** taux_ethanol (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 4.57; 7 PC(s) → 95% variance, 14 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.0034, max class-proportion Δ 0.002
