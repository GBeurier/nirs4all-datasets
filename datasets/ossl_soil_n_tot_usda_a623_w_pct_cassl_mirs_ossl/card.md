# Datasheet — OSSL — soil_n_tot_usda_a623_w_pct_cassl_mirs_ossl
...
- **Instances:** 1578 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.64; 4 PC(s) → 95% variance, 10 → 99%.
