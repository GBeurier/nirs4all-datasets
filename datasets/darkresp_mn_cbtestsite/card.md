# Datasheet — DarkResp — Mn_CBtestSite
...
- **PCA / dimensionality:** effective rank 1.71; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.836, KS 0.395 (p 5.01e-16), Wasserstein 0.0393
