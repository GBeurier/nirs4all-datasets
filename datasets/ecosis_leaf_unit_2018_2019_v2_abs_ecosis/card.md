# Datasheet — ECOSIS — leaf_unit_2018_2019_v2_abs_ecosis
...
- **Instances:** 38 spectra × 1971 wavelengths, 1 source(s).
...
- **Targets:** Unit (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1; 1 PC(s) → 95% variance, 1 → 99%.
