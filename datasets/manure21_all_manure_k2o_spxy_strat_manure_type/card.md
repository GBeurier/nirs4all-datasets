# Datasheet — MANURE21 — All_manure_K2O_SPXY_strat_Manure_type
...
- **Description:** MANURE21 dataset (regression). Sample: Cattle manure. Trait: K2O content. Split: strat spxy. Auto-generated descriptor (verify before publication).
...
- **Train↔test target shift:** std. mean diff -0.168, KS 0.126 (p 0.069), Wasserstein 1.33

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** K2O content
