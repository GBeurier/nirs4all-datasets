# Datasheet — DarkResp — Rd25_CBtestSite
...
- **PCA / dimensionality:** effective rank 1.74; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.784, KS 0.33 (p 3.01e-10), Wasserstein 0.215
