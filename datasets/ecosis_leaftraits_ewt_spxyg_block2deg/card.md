# Datasheet — ECOSIS_LeafTraits — EWT_spxyG_block2deg
...
- **Description:** ECOSIS_LeafTraits dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** GitHub

## Composition

- **Instances:** 3583 spectra × 196 wavelengths, 1 source(s).
...
- **Targets:** EWT (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.37; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.0418, KS 0.0888 (p 4.06e-06), Wasserstein 8.72e+04
