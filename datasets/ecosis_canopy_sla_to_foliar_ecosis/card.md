# Datasheet — ECOSIS — canopy_sla_to_foliar_ecosis
...
- **Instances:** 666 spectra × 426 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 3.8; 14 PC(s) → 95% variance, 28 → 99%.
