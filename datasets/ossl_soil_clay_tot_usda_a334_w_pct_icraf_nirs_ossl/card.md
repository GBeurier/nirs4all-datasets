# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_icraf_nirs_ossl
...
- **Instances:** 3740 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.33; 3 PC(s) → 95% variance, 5 → 99%.
