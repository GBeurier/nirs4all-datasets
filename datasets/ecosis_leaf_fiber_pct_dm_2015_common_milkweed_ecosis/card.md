# Datasheet — ECOSIS — leaf_fiber_pct_dm_2015_common_milkweed_ecosis
...
- **Instances:** 386 spectra × 735 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1.0, 735.0] nm; signal type absorbance.
- **Targets:** Fiber_pct_dm (regression)
