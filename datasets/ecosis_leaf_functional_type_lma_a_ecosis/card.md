# Datasheet — ECOSIS — leaf_functional_type_lma_a_ecosis
...
- **Instances:** 2150 spectra × 6108 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [0.0, 6107.0] cm-1; signal type unknown.
- **Targets:** functional_type (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.02; 1 PC(s) → 95% variance, 2 → 99%.
