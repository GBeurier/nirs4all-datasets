# Datasheet — OSSL — soil_n_tot_usda_a623_w_pct_schiedung_mirs_ossl
...
- **Instances:** 239 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.9; 5 PC(s) → 95% variance, 8 → 99%.
