# Datasheet — ARABIDOPSIS_CEFE — Genotype10_250
...
- **Instances:** 250 spectra × 2152 wavelengths, 1 source(s).
...
- **Targets:** G (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 3; 4 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.148, max class-proportion Δ 0.08
