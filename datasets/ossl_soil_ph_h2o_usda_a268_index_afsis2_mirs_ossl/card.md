# Datasheet — OSSL — soil_ph_h2o_usda_a268_index_afsis2_mirs_ossl
...
- **Instances:** 151 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.93; 5 PC(s) → 95% variance, 10 → 99%.
