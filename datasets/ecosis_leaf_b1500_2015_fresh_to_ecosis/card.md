# Datasheet — ECOSIS — leaf_b1500_2015_fresh_to_ecosis
...
- **Instances:** 303 spectra × 1150 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [350.0, 1499.0] nm; signal type unknown.
- **Targets:** B1500 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.21; 2 PC(s) → 95% variance, 5 → 99%.
