# Datasheet — ECOSIS — leaf_sla_cm2_gdw_2016_2016_ngee_tropics_ecosis
...
- **Instances:** 585 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** SLA_cm2_gDW (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.38; 3 PC(s) → 95% variance, 6 → 99%.
