# Datasheet — DIESEL — DIESEL_t_256_hlb-a
...
- **Instances:** 256 spectra × 401 wavelengths, 1 source(s).
...
- **Targets:** t (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.26; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.0486, KS 0.0674 (p 0.908), Wasserstein 0.787
