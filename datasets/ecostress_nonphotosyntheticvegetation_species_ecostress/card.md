# Datasheet — ECOSTRESS — nonphotosyntheticvegetation_species_ecostress
...
- **Description:** ECOSTRESS dataset (classification). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 123 spectra × 2868 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [0.4, 14.9831] nm; signal type unknown.
- **Targets:** species (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 2.47; 4 PC(s) → 95% variance, 7 → 99%.
