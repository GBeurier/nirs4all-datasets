# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_kellogg_nirs_ossl
...
- **Instances:** 50009 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.2; 2 PC(s) → 95% variance, 3 → 99%.
