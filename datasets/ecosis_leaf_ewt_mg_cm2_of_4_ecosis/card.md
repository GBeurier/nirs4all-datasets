# Datasheet — ECOSIS — leaf_ewt_mg_cm2_of_4_ecosis
...
- **Instances:** 2399 spectra × 2051 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [400.0, 2450.0] nm; signal type unknown.
- **Targets:** EWT_mg_cm2 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.2; 3 PC(s) → 95% variance, 5 → 99%.
