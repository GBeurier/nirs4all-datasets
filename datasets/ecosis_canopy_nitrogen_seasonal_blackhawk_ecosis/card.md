# Datasheet — ECOSIS — canopy_nitrogen_seasonal_blackhawk_ecosis
...
- **Instances:** 80 spectra × 187 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [407.1, 2389.4] nm; signal type unknown.
- **Targets:** nitrogen (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.34; 2 PC(s) → 95% variance, 4 → 99%.
