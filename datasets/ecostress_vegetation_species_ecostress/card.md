# Datasheet — ECOSTRESS — vegetation_species_ecostress
...
- **Instances:** 1040 spectra × 2868 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 3.13; 5 PC(s) → 95% variance, 10 → 99%.
