# Datasheet — EcoSIS CABO 2018-2019 Leaf-Level Spectra v2 (absorbance)
...
- **Description:** EcoSIS CABO 2018-2019 Leaf-Level Spectra v2 (absorbance). v2.0 standardized NIRS package: 1 spectral source(s), 51 declared target(s). Auto-generated from dataset_card.json (verify before publication).
...
| --- | --- | --- | --- | --- | --- | --- |
| X | ref_spec.csv | Spectra Vista Corporation HR-1024i | NIR | 400–2400 nm | 1971 | 2001 |
...
| Narea | target | numeric | *Not specified.* | n=1971, missing=34, range 3.194e-05–0.0005152, mean 0.0001542 ± 6.173e-05 |
| Carea | target | numeric | *Not specified.* | n=1971, missing=34, range 0.0003681–0.02103, mean 0.003718 ± 0.002776 |
| solubles_area | target | numeric | *Not specified.* | n=1971, missing=78, range 0.0005307–0.02528, mean 0.004988 ± 0.003543 |
| hemicellulose_area | target | numeric | *Not specified.* | n=1971, missing=82, range 7.847e-05–0.005191, mean 0.001048 ± 0.0008274 |
| cellulose_area | target | numeric | *Not specified.* | n=1971, missing=51, range 0.00012–0.007309, mean 0.001102 ± 0.001026 |
| lignin_area | target | numeric | *Not specified.* | n=1971, missing=51, range 2.12e-05–0.004556, mean 0.0006518 ± 0.000698 |
| chlA_area | target | numeric | *Not specified.* | n=1971, missing=56, range 8.885e-06–0.0002939, mean 4.685e-05 ± 2.367e-05 |
| chlB_area | target | numeric | *Not specified.* | n=1971, missing=56, range 2.971e-06–9.463e-05, mean 1.562e-05 ± 7.601e-06 |
| car_area | target | numeric | *Not specified.* | n=1971, missing=56, range 2.482e-06–5.86e-05, mean 1.005e-05 ± 4.7e-06 |
| Al_area | target | numeric | *Not specified.* | n=1971, missing=1307, range 0–4.327e-06, mean 4.052e-07 ± 3.874e-07 |
| Ca_area | target | numeric | *Not specified.* | n=1971, missing=1306, range 1.26e-05–0.0003779, mean 7.941e-05 ± 5.325e-05 |
| Cu_area | target | numeric | *Not specified.* | n=1971, missing=1309, range 0–2.611e-07, mean 4.908e-08 ± 2.668e-08 |
| Fe_area | target | numeric | *Not specified.* | n=1971, missing=1307, range 1.799e-07–2.787e-06, mean 5.063e-07 ± 2.551e-07 |
| K_area | target | numeric | *Not specified.* | n=1971, missing=1306, range 1.482e-05–0.0002228, mean 4.735e-05 ± 2.391e-05 |
| Mg_area | target | numeric | *Not specified.* | n=1971, missing=1306, range 3.179e-06–8.179e-05, mean 1.761e-05 ± 9.907e-06 |
| Mn_area | target | numeric | *Not specified.* | n=1971, missing=1306, range 0–1.62e-05, mean 1.783e-06 ± 2.501e-06 |
| Na_area | target | numeric | *Not specified.* | n=1971, missing=1306, range 0–6.958e-05, mean 8.037e-06 ± 1.022e-05 |
| P_area | target | numeric | *Not specified.* | n=1971, missing=1306, range 3.089e-06–7.277e-05, mean 1.217e-05 ± 7.683e-06 |
| Zn_area | target | numeric | *Not specified.* | n=1971, missing=1307, range 2.297e-08–2.89e-06, mean 4.988e-07 ± 5.733e-07 |
| ecosis_resource_id | metadata | categorical | *Not specified.* | n=1971, missing=0, classes=1, top a8f5093c-4383-40ad-85ae-4ad0d7a22eff (×1971) |
...
| signal_type | metadata | categorical | *Not specified.* | n=1971, missing=0, classes=1, top absorbance (×1971) |
...
- **Content hash:** `39fb2fd05696a939f02f229ec039d6a7825031a8113818e15f8297104f7d158a`
- **Processing hash:** `1c3aefda588b5c452d4297772ea0d91f95ce4ea1955155956db153299c4674d6` | **metadata hash:** `c26930f936e964973a5f4bcd4e60132dc636254d4a7b7129e3b490c6a2d83893`
