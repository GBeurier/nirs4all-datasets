# Datasheet — DarkResp — Ca_XSBNtestSite
...
- **PCA / dimensionality:** effective rank 1.83; 2 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.33, KS 0.181 (p 0.00088), Wasserstein 0.13
