# Datasheet — ECOSIS — leaf_lma_g_m2_2014_cedar_creek_ecosis
...
- **Instances:** 807 spectra × 2101 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.24; 2 PC(s) → 95% variance, 4 → 99%.
