# Datasheet — BISCUIT — Biscuit_Sucrose_40_RandomSplit
...
- **Description:** BISCUIT dataset (regression). Sample: Biscuit dough. Trait: Sucrose content. Split: Random. Auto-generated descriptor (verify before publication).
- **Contributor:** https://rdrr.io/cran/fds/man/Biscuit.html

## Composition

- **Instances:** 72 spectra × 700 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1100.0, 2498.0] nm; signal type unknown.
- **Targets:** Sucrose content (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.14; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff 0.028, KS 0.0375 (p 1), Wasserstein 0.184

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Sucrose content
