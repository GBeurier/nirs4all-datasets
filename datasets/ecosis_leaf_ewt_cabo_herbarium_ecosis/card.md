# Datasheet — ECOSIS — leaf_ewt_cabo_herbarium_ecosis
...
- **Instances:** 600 spectra × 2001 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [400.0, 2400.0] nm; signal type unknown.
- **Targets:** EWT (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.63; 5 PC(s) → 95% variance, 8 → 99%.
