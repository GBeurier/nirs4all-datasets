# Datasheet — ARABIDOPSIS_CEFE — Group_2185
...
- **Instances:** 2185 spectra × 2152 wavelengths, 1 source(s).
...
- **Targets:** Gr (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.66; 4 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.128, max class-proportion Δ 0.0413
