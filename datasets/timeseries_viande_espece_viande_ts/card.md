# Datasheet — TIMESERIES — viande_espece_viande_ts
...
- **Instances:** 120 spectra × 448 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1000.0, 1800.0] nm; signal type preprocessed.
- **Targets:** espece_viande (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.6; 3 PC(s) → 95% variance, 11 → 99%.
