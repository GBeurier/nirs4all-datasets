# Datasheet — ECOSIS — canopy_treatment_2009_2016_to_cedar_ecosis
...
- **Instances:** 25414 spectra × 5 wavelengths, 1 source(s).
...
- **Targets:** Treatment (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 2.72; 3 PC(s) → 95% variance, 4 → 99%.
