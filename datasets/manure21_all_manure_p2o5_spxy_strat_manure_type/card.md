# Datasheet — MANURE21 — All_manure_P2O5_SPXY_strat_Manure_type
...
- **Description:** MANURE21 dataset (regression). Sample: Cattle manure. Trait: P2O5 content. Split: strat spxy. Auto-generated descriptor (verify before publication).
...
- **Targets:** P2O5 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.18; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.104, KS 0.129 (p 0.0591), Wasserstein 1.02

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** P2O5 content
