# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_schiedung_mirs_ossl
...
- **Instances:** 250 spectra × 1701 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [600.0, 4000.0] cm-1; signal type absorbance.
- **Targets:** clay_tot_usda_a334_w_pct (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.84; 5 PC(s) → 95% variance, 8 → 99%.
