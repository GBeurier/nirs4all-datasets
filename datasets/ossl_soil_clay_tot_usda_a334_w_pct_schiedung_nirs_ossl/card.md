# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_schiedung_nirs_ossl
...
- **Instances:** 250 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank *Not specified.*; 1 PC(s) → 95% variance, 1 → 99%.
