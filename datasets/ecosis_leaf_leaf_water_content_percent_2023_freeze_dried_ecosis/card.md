# Datasheet — ECOSIS — leaf_leaf_water_content_percent_2023_freeze_dried_ecosis
...
- **Instances:** 486 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.53; 4 PC(s) → 95% variance, 7 → 99%.
