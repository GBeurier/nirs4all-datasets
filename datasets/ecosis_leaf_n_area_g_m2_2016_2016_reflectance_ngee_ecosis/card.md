# Datasheet — ECOSIS — leaf_n_area_g_m2_2016_2016_reflectance_ngee_ecosis
...
- **Instances:** 660 spectra × 199 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1818.0, 2193.0] nm; signal type unknown.
- **Targets:** N_area_g_m2 (regression)
