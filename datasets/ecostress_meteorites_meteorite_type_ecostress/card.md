# Datasheet — ECOSTRESS — meteorites_meteorite_type_ecostress
...
- **Instances:** 59 spectra × 2868 wavelengths, 1 source(s).
...
- **Targets:** meteorite_type (multiclass_classification)
