# Datasheet — FUSARIUM — PhiPS2calc_grp70_30
...
- **Description:** FUSARIUM dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** tabpfn NIRS benchmark collection

## Composition

- **Instances:** 665 spectra × 2177 wavelengths, 1 source(s).
...
- **Targets:** ﻿PhiPS2calc (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.91; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff -0.041, KS 0.0745 (p 0.383), Wasserstein 0.0145
