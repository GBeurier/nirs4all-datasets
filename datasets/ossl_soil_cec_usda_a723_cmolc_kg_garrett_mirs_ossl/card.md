# Datasheet — OSSL — soil_cec_usda_a723_cmolc_kg_garrett_mirs_ossl
...
- **Instances:** 183 spectra × 1701 wavelengths, 1 source(s).
...
- **Targets:** cec_usda_a723_cmolc_kg (regression)
