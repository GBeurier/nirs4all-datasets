# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_kellogg_mirs_ossl
...
- **Instances:** 50009 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.09; 6 PC(s) → 95% variance, 14 → 99%.
