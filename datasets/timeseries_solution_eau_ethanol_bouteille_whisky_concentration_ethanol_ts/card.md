# Datasheet — TIMESERIES — solution_eau_ethanol_bouteille_whisky_concentration_ethanol_ts
...
- **Description:** TIMESERIES dataset (classification). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 1572 spectra × 1751 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [226.0, 1101.0] nm; signal type unknown.
- **Targets:** concentration_ethanol (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.12; 2 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** Jensen–Shannon 0.00324, max class-proportion Δ 0.00192
