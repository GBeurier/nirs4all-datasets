# Datasheet — BEER — Beer_OriginalExtract_60_KS
...
- **Domain / purpose:** beer
- **Description:** BEER dataset (regression). Sample: Beer. Trait: Original extract. Split: KS. Auto-generated descriptor (verify before publication).
- **Contributor:** GitHub

## Composition

- **Instances:** 60 spectra × 576 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1100.0, 2250.0] nm; signal type unknown.
- **Targets:** Original extract (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 14.3; 33 PC(s) → 95% variance, 38 → 99%.
- **Train↔test target shift:** std. mean diff -0.0457, KS 0.225 (p 0.493), Wasserstein 0.761

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Original extract
