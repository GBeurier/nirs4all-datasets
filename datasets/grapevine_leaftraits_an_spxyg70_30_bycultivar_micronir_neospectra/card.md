# Datasheet — GRAPEVINE_LeafTraits — An_spxyG70_30_byCultivar_MicroNIR_NeoSpectra
...
- **Instances:** 115 spectra × 276 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.4; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.268, KS 0.157 (p 0.528), Wasserstein 1.11
