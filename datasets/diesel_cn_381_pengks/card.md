# Datasheet — DIESEL — DIESEL_CN_381_PengKS
...
- **PCA / dimensionality:** effective rank 1.81; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff -0.0915, KS 0.114 (p 0.229), Wasserstein 0.658
