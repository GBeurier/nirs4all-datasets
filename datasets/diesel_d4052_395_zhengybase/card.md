# Datasheet — DIESEL — DIESEL_D4052_395_ZhengYbase
...
- **Description:** DIESEL dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** NIRS DB reference collection

## Composition

- **Instances:** 395 spectra × 401 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [750.0, 1550.0] nm; signal type absorbance.
- **Targets:** D4052 (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.77; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.00211, KS 0.00633 (p 1), Wasserstein 0.00036
...
- **Citation:** https://doi.org/10.1016/j.chemolab.2018.09.009
