# Datasheet — OSSL — soil_ph_h2o_usda_a268_index_icraf_nirs_ossl
...
- **Instances:** 3776 spectra × 1076 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.32; 3 PC(s) → 95% variance, 5 → 99%.
