# Datasheet — RRUFF — mineral_mineral_name_rruff_infrared
...
- **Instances:** 816 spectra × 1761 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [600.0, 3993.984] cm-1; signal type unknown.
- **Targets:** mineral_name (multiclass_classification)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.09; 1 PC(s) → 95% variance, 2 → 99%.
