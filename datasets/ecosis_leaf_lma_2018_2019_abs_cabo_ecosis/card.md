# Datasheet — ECOSIS — leaf_lma_2018_2019_abs_cabo_ecosis
...
- **Instances:** 1943 spectra × 2001 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.29; 2 PC(s) → 95% variance, 4 → 99%.
