# Datasheet — GRAPEVINES — grapevine_chloride_260_KS
...
- **Description:** GRAPEVINES dataset (regression). Auto-generated descriptor (verify before publication).
- **Contributor:** tabpfn NIRS benchmark collection

## Composition

- **Instances:** 259 spectra × 228 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [901.0, 1702.0] nm; signal type unknown.
- **Targets:** average (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.25; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 0.206, KS 0.273 (p 0.000428), Wasserstein 405
