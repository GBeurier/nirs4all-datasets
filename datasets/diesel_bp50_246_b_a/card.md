# Datasheet — DIESEL — DIESEL_bp50_246_b-a
...
- **Instances:** 226 spectra × 401 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.35; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.478, KS 0.195 (p 0.0274), Wasserstein 5.7
