# Datasheet — ECOSIS — canopy_adf_a_pct_dw_foliar_chemical_ecosis
...
- **Instances:** 304 spectra × 225 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [366.0, 2500.0] nm; signal type unknown.
- **Targets:** ADF_A_pct_DW (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 10.4; 13 PC(s) → 95% variance, 16 → 99%.
