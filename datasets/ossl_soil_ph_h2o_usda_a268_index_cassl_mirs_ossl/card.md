# Datasheet — OSSL — soil_ph_h2o_usda_a268_index_cassl_mirs_ossl
...
- **Instances:** 483 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.38; 3 PC(s) → 95% variance, 7 → 99%.
