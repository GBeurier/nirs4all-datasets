# Datasheet — DarkResp — Mg_XSBNtestSite
...
- **Instances:** 504 spectra × 2151 wavelengths, 1 source(s).
...
- **Targets:** Mg (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.79; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.232, KS 0.139 (p 0.0238), Wasserstein 0.0245
