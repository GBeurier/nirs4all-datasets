# Datasheet — ECOSTRESS — soil_soil_type_ecostress
...
- **Instances:** 69 spectra × 2868 wavelengths, 1 source(s).
...
- **Targets:** soil_type (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 3.25; 4 PC(s) → 95% variance, 8 → 99%.
