...
- **Description:** PLUMS dataset (regression). Sample: Plum. Trait: Brix. Split: spxy. Auto-generated descriptor (verify before publication).
- **Contributor:** GitHub

## Composition

- **Instances:** 40 spectra × 600 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [1100.0, 2298.0] nm; signal type absorbance.
- **Targets:** Brix (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.11; 2 PC(s) → 95% variance, 2 → 99%.
- **Train↔test target shift:** std. mean diff -0.43, KS 0.393 (p 0.117), Wasserstein 0.511
