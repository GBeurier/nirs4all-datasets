# Datasheet — FUSARIUM — Tleaf_grp70_30
...
- **Targets:** ﻿Tleaf (regression)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.95; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff -0.00528, KS 0.0452 (p 0.917), Wasserstein 0.246

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Leaf temperature
