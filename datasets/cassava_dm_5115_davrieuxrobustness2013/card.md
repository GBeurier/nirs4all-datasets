# Datasheet — CASSAVA — Cassava_DM_5115_DavrieuxRobustness2013
...
- **Instances:** 5115 spectra × 1050 wavelengths, 1 source(s).
...
- **Targets:** DM (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.62; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.206, KS 0.161 (p 1.81e-26), Wasserstein 1.63
