# Datasheet — LUCAS — LUCAS_SOC_all_26650_NocitaKS
...
- **Instances:** 19036 spectra × 4200 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [400.0, 2499.5] nm; signal type unknown.
- **Targets:** Soil organic content (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.3; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.562, KS 0.26 (p 1.1e-239), Wasserstein 42.6
