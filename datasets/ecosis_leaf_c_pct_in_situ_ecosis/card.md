# Datasheet — ECOSIS — leaf_c_pct_in_situ_ecosis
...
- **Instances:** 1729 spectra × 781 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [320.0, 1100.0] nm; signal type unknown.
- **Targets:** C_pct (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 2.27; 4 PC(s) → 95% variance, 9 → 99%.
