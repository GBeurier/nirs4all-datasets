# Datasheet — LUCAS — LUCAS_SOC_Woodland_5040_NocitaKS
...
- **Instances:** 5040 spectra × 4200 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.31; 2 PC(s) → 95% variance, 4 → 99%.
- **Train↔test target shift:** std. mean diff -0.63, KS 0.247 (p 2.92e-57), Wasserstein 21.2
