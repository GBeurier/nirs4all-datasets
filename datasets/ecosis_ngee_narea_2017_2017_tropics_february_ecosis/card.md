# Datasheet — ECOSIS — ngee_narea_2017_2017_tropics_february_ecosis
...
- **Instances:** 133 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.87; 3 PC(s) → 95% variance, 6 → 99%.
