# Datasheet — ECOSIS — leaf_starch_spectroscopy_biochemical_ecosis
...
- **Instances:** 249 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.96; 3 PC(s) → 95% variance, 6 → 99%.
