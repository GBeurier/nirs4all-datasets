# Datasheet — ECOSIS — leaf_narea_2017_2017_reflectance_ngee_ecosis
...
- **Instances:** 120 spectra × 2151 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 1.76; 3 PC(s) → 95% variance, 5 → 99%.
