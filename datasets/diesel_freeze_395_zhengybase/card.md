# Datasheet — DIESEL — DIESEL_FREEZE_395_ZhengYbase
...
- **Targets:** FREEZE (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.87; 3 PC(s) → 95% variance, 5 → 99%.
- **Train↔test target shift:** std. mean diff 0.00298, KS 0.00633 (p 1), Wasserstein 0.267
