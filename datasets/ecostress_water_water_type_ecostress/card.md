# Datasheet — ECOSTRESS — water_water_type_ecostress
...
- **Instances:** 9 spectra × 2868 wavelengths, 1 source(s).
...
- **Targets:** water_type (multiclass_classification)
- **Contains missing values:** True

## Statistics

- **PCA / dimensionality:** effective rank 1.19; 2 PC(s) → 95% variance, 2 → 99%.
