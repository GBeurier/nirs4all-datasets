# Datasheet — CASSAVA — Cassava_TCC_4930_DavrieuxRobustness2014
...
- **Instances:** 4930 spectra × 1050 wavelengths, 1 source(s).
...
- **Targets:** TCC (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.68; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff 1.55, KS 0.624 (p 4.47e-156), Wasserstein 5.88
