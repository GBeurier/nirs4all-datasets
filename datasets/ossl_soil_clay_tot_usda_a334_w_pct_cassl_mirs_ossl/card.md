# Datasheet — OSSL — soil_clay_tot_usda_a334_w_pct_cassl_mirs_ossl
...
- **Instances:** 511 spectra × 1701 wavelengths, 1 source(s).
...
- **PCA / dimensionality:** effective rank 2.05; 5 PC(s) → 95% variance, 11 → 99%.
