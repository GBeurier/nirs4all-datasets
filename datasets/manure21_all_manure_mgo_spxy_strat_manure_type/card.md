# Datasheet — MANURE21 — All_manure_MgO_SPXY_strat_Manure_type
...
- **Description:** MANURE21 dataset (regression). Sample: Cattle manure. Trait: MgO content. Split: strat spxy. Auto-generated descriptor (verify before publication).
...
- **Targets:** MgO (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.17; 2 PC(s) → 95% variance, 3 → 99%.
- **Train↔test target shift:** std. mean diff -0.145, KS 0.144 (p 0.0257), Wasserstein 0.411

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** MgO content
...
- **Citation:** https://doi.org/10.1016/j.dib.2020.106647
