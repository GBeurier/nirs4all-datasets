# Datasheet — FUSARIUM — Fv_Fm_grp70_30
...
- **Description:** FUSARIUM dataset (regression). Sample: Fresh leaf. Trait: Photochemical potential (Fv/Fm). Split: Group stratified. Auto-generated descriptor (verify before publication).
- **Contributor:** Zenodo

## Composition

- **Instances:** 518 spectra × 2177 wavelengths, 1 source(s).
- **Modality / instrument:** NIR — *Not specified.* *Not specified.* (firmware *Not specified.*).
- **Spectral axis:** [339.0, 2515.0] nm; signal type unknown.
- **Targets:** ﻿Fv/Fm (regression)
- **Contains missing values:** False

## Statistics

- **PCA / dimensionality:** effective rank 1.9; 3 PC(s) → 95% variance, 6 → 99%.
- **Train↔test target shift:** std. mean diff -0.0366, KS 0.068 (p 0.639), Wasserstein 0.00357

## Collection process

- **Collection date:** *Not specified.*
- **Reference method:** Photochemical potential (Fv/Fm)
