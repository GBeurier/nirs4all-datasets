# Datasheet — ECOSTRESS water all axis 21cbe3b0
...
- **Description:** ECOSTRESS water all axis 21cbe3b0. v2.0 standardized NIRS package: 1 spectral source(s), 4 declared target(s). Auto-generated from dataset_card.json (verify before publication).
...
| --- | --- | --- | --- | --- | --- | --- |
| X | water all | source instruments vary by sample | other | 0.34–14.01 none | 4 | 965 |

### Variables (Y / metadata)

| Name | Role | Type | Unit | Summary |
| --- | --- | --- | --- | --- |
| material_name | target | categorical | *Not specified.* | n=4, missing=0, classes=4, top Frost (×1) |
| class_label | target | categorical | *Not specified.* | n=4, missing=0, classes=2, top Snow (×3) |
| subclass | target | categorical | *Not specified.* | n=4, missing=1, classes=3, top Coarse Granular (×1) |
| particle_size | target | categorical | *Not specified.* | n=4, missing=0, classes=3, top Fine (×2) |
| ecostress_resource_id | metadata | categorical | *Not specified.* | n=4, missing=0, classes=4, top water.frost.none.fine.all.frost_snw_.jhu.becknic.spectrum (×1) |
| category | metadata | categorical | *Not specified.* | n=4, missing=0, classes=1, top water (×4) |
| material_type | metadata | categorical | *Not specified.* | n=4, missing=0, classes=1, top Water (×4) |
| site | metadata | categorical | *Not specified.* | n=4, missing=4, classes=0, — |
| location | metadata | categorical | *Not specified.* | n=4, missing=0, classes=2, top Collected at John Hopkins University IR Spectroscopy Lab. (×3) |
...
| sample_description | metadata | categorical | *Not specified.* | n=4, missing=0, classes=4, top Frost. The spectrum from 0.3 to 2.08 micrometers was modeled, while that from 2.08 to 14 micrometers was measured. The effective particle size was 10 micrometers (see Introductory text for details). Original filename FROST.SNW. Original ASTER Spectral Library name was jhu.becknic.water.frost.none.10um.frost.spectrum.txt (×1) |
...
| axis_min | metadata | numeric | *Not specified.* | n=4, missing=0, range 0.34–0.34, mean 0.34 ± 0 |
| axis_max | metadata | numeric | *Not specified.* | n=4, missing=0, range 14.01–14.01, mean 14.01 ± 0 |
| n_points_original | metadata | numeric | *Not specified.* | n=4, missing=0, range 965–965, mean 965 ± 0 |
...
- **Content hash:** `fef31ea9704849e119d27af9fee7ebee27dc1aaa72889ed8f61b84a37eca73ec`
- **Processing hash:** `1c1e123608cfd59349b3658a522a919a2a55c87ebccc7eb3e7851dcd5718f0a9` | **metadata hash:** `96180e8a1ce9eacfbed32b622dca00a8f8670c83c7421cd3065b818178021e09`
