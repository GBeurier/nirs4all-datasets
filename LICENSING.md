# Licensing — nirs4all-datasets

`nirs4all-datasets` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-datasets` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-datasets` relies on third-party open-source components. Their licenses are summarized
